...
Scenarios_AC_Up = Scenarios_AC_Up(1:downsample_ratio:end, :);
Scenarios_EV_Up = Scenarios_EV_Up(1:downsample_ratio:end, :);
Scenarios_AC_Down = Scenarios_AC_Down(1:downsample_ratio:end, :);
Scenarios_EV_Down = Scenarios_EV_Down(1:downsample_ratio:end, :);
Reliable_AC_Base = Reliable_AC_Base(1:downsample_ratio:end);
Reliable_EV_Base = Reliable_EV_Base(1:downsample_ratio:end);
Reliable_AC_Up = Reliable_AC_Up(1:downsample_ratio:end);
Reliable_EV_Up = Reliable_EV_Up(1:downsample_ratio:end);
Reliable_AC_Down = Reliable_AC_Down(1:downsample_ratio:end);
Reliable_EV_Down = Reliable_EV_Down(1:downsample_ratio:end);
...
cost_params.c1_gen = 800;    cost_params.c2_gen = 50; % 火电较贵
...
% --- 4. 制定“日前发电计划” ---
P_Gen_Schedule = movmean(P_Net_Load, floor(4/dt)); 
