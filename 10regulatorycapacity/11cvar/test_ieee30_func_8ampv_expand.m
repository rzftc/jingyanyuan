...
cost_params.c1_gen = 2000;    cost_params.c2_gen = 80; % 火电较贵
...
%% 1. 运行场景 B: 风险偏好灵敏度分析
strategies = run_scenario_B_expand(beta_values, Max_Iter, N_scenarios, N_bus, N_line, dt, ...
...
%% 4. 运行场景 E: 置信水平测试
run_scenario_E_expand(P_grid_demand, Scenarios_AC_Up, Scenarios_EV_Up, ...
