...
function [u_ac, u_ev, cost, exitflag] = solve_hourly_dispatch_ptdf( ...
    ...
    P_Line_Base_t, P_Line_Max, N_bus, N_line,t_global_for_warning)
...
% 同时满足功率需求、GA数量约束和PTDF网络潮流约束。
   ...
   options = optimoptions('intlinprog', ...
    'Display', 'off', ...
    'MaxTime', 120, ...              % [修改1]：将超时时间延长到120秒
    'RelativeGapTolerance', 0.02, ... % [修改2]：如果找到的解在最优解的2%以内，就停止
    'AbsoluteGapTolerance', 10);     % [修改3]：如果找到的解离最优解的成本差距小于10元，就停止
