function fitness = objectiveFunction_up_dt(x, n_AC_max, n_EV_max, deltaP_AC, deltaP_EV, T, ...
    ...
    SDCI_plus = calculateSDCI(n_AC', n_EV', avg_deltaP_AC', avg_deltaP_EV');
    rho_plus = calculateSpearmanRho(n_AC', avg_deltaP_AC', n_EV', avg_deltaP_EV');
